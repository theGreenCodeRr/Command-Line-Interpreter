...
public class Terminal {
	...
	public String cp(String sourcePath,String destinationPath) throws IOException {
	...
	public String mv(String sourcePath,String destinationPath) throws IOException {
		int ind=sourcePath.lastIndexOf("\\");
		String filename="";
	...
	public String args() {
		...
		CommandParameter.add("mv\t take 2 args: sourcePath , destinationPath");
		CommandParameter.add("clear\t take 0 args");
		CommandParameter.add("more\t take 0 args");
		CommandParameter.add("cp\t take 2 args : sourcePath , destinationPath");
	...
	for(int i=0;i<Lines.size();i++) {
		if((i+1)%6==0) {
			System.out.println("To print next 5 lines >> y or >> n to top");
